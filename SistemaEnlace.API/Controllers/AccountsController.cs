...
namespace SistemaEnlace.API.Controllers
{
    ...
    public class AccountsController : ControllerBase
    {
        ...
        public async Task<ActionResult> CreateUser([FromBody] UserDTO model)
        {
            ...
            if (result.Succeeded)
            {
                ...
                var response = _mailHelper.SendMail(user.FullName, user.Email!,
                    $"Sistema de tutores- Confirmación de cuenta",
                    $"<h1>Sistema de tutores - Confirmación de cuenta</h1>" +
        ...
        public async Task<ActionResult> RecoverPassword([FromBody] EmailDTO model)
        {
            ...
            var response = _mailHelper.SendMail(user.FullName, user.Email!,
                $"Sitema de tutores - Recuperación de contraseña",
                $"<h1>Sistema de tutores - Recuperación de contraseña</h1>" +
